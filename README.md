# monster
 ...
 This game mode can be played on any minecraft map. On start, one random person is chosen to be the monster and is notified. For every kill they get, they gain health. They also get a buff upon getting a kill that increases their max hearts. Every minute the monster recieves a item which when right clicked while pointing at the air will locate the nearest
 player. They can also craft and use golden apples in a similar manner to raise their base attack damage.
